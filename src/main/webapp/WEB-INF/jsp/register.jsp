...
<div style="  color :azure; margin-top: 5px; margin-left: 7px; margin-right: 7px;
    ...
    background-color:#dc143c; ">
        <header>
           ...
           <a class="btn btn-danger" href="/registerForm"  style="float:right;">Register</a></div>
    </div>

    </div>
  <div style="
    display:flex;">
    <form action="registerForm"" method="post" style="margin:auto; padding-top: 120px; color:#dc143c; ">
